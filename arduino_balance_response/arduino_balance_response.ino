...
void loop () {
  if (Serial.available()) {
    ...
    if(ByteCount > 0) {
      ...
      if(strcmp( buffer, "AX:T?\r") == 0 ) Serial.println("XA:T0002");  
      else if(strcmp( buffer, "AX:N?\r") == 0 ) Serial.println("XA:N0010"); 
      else if(strcmp( buffer, "AX:B?\r") == 0 ) Serial.println("XA:B0012");
